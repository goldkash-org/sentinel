...
# TODO: remove fixtures below here once test_SHIM_serialise_for_goldkashd removed
...
@pytest.fixture
def goldkashd_superblock_hex():
    return ''

# ========================================================================


def test_SHIM_serialise_for_goldkashd(sentinel_proposal_hex, sentinel_superblock_hex):
    assert goldkashlib.SHIM_serialise_for_goldkashd(sentinel_proposal_hex) == ''
    assert goldkashlib.SHIM_serialise_for_goldkashd(sentinel_superblock_hex) == ''
...
def test_extract_object():
    ...
    expected = {
        ...
        'url': 'https://www.goldkashcentral.org/black-pearl',
